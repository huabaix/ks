var mediaData = {
  ...
  audioFiles: [
    ...
    titles : ["第一章","滴文章","第三章","第四章ssd","The next heading is Switch Options, parameters.","Take a guided tour","symlinks","hard-wired"] ,
    time:[ [5,585] ,[585,1457] , [1457,2248] ,[2249,3984],[3985,5490],[5491,6487],[6488,6561],[6561,6766]],
    content:[
      ["  2"],
      ["  2"],
    ...
    titles : ["大苏打的","The next heading is Switch Options, parameters."," One-character format","Run the less command to view the file content.","Take a guided tour","symlinks","hard-wired","summary"] ,
    time:[ [5,585] ,[585,1457] , [1457,2248] ,[2249,3984],[3985,5490],[5491,6487],[6488,6561],[6561,6766]],
    },  {fileName:["cs1.mp3" ],
    titles : ["4你好这是一个文字","The next heading is Switch Options, parameters."," One-character format","Run the less command to view the file content.","Take a guided tour","symlinks","hard-wired","summary"] ,
     time:[ [5,585] ,[585,1457] , [1457,2248] ,[2249,3984],[3985,5490],[5491,6487],[6488,6561],[6561,6766]],
    }],
